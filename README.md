...
- Physically aware of sun and moon placement
- Coloring based on sky/sun color/Time of day
- Shading based on sun direction
- "fake" subsurface scattering
- Rim lighting on clouds from sun/moon
- Well optimized - this is literally just a dome with a scrolling 2D texture on it with cool shader tricks to give it depth
